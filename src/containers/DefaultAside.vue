    ...
    <b-tab>
      ...
      <div class="p-3">
        ...
        <div class="aside-options">
          ...
          <div>
            <small class="text-muted">Lorem ipsum dolor sit gregory rmet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</small>
          </div>
        </div>
        <div class="aside-options">
